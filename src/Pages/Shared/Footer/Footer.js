                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div className="footer-widget">
                            ...
                            <ul className='useFull'>
                                ...
                                <li><Link to="/home">Our Services</Link></li>
                                <li><Link to="/home">Expert Team</Link></li>
                                <li><Link to="/home">Contact us</Link></li>
                                <li><Link to="/login">Latest News</Link></li>
                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div className="copyright-text">
                            <p>Copyright &copy; 2024, All Rights Reserved <a href="https://codepen.io/anupkumar92/">Noman</a></p>
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-6 d-none d-lg-block text-right">
                        <div className="footer-menu">
                            <ul>
                                ...
                                <li><Link to="/home">Home</Link></li>
                                <li><Link to="/home">Terms</Link></li>
                                <li><Link to="/login">Privacy</Link></li>
                                <li><Link to="/home">Policy</Link></li>
                                <li><Link to="/register">Contact</Link></li>
